...
class _ImageSelectorPageState extends State<ImageSelectorPage> {
  ...
  Widget build(BuildContext context) {
    ...
    var images = istStepperModel.imagesSelector;
        ...
        child: new StaggeredGridView.countBuilder(
          ...
          itemBuilder: (BuildContext context, int index) => FlatButton(
            ...
            onPressed: () async {
              ...
              istStepperModel.indexSelected = images[index];
              print('selected: ${istStepperModel.indexSelected}');
                    ...
                    image: DecorationImage(
                        image: images.length > 0
                            ? CachedNetworkImageProvider(
                                '${ApiHelper.baseUrl}${images[index]['uploadfile']}',
                                scale: 0.2,
                                errorListener: () {
